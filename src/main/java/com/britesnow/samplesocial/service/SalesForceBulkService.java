...
public class SalesForceBulkService {
    
    private  static final String VERSION = "29.0";
    private  static final String SF_URL = "/services/async/"+VERSION;


    public static void main(String[] args)
      throws AsyncApiException, ConnectionException, IOException {
        SalesForceBulkService example = new SalesForceBulkService();
        ...
        String content = "FirstName,LastName\n " + "bulkF1,bulkL1\n "
                                + "bulkF2,bulkL2\n "
                                + "bulkF3,bulkL3\n ";
        example.runSample("Contact", "00Dd0000000geI4!AR0AQNHHqJJE_bNQqdbTNRJ2J04b7TRIOe4vUshJZ425LHfvKQPfEwaIdH9tW8ltCf5uU.6FK9rt7Vkl8dgNDNtcf7c9623K", "https://na14.salesforce.com", content);
    }

    /**
     * Creates a Bulk API job and uploads batches for a CSV file.
     */
    public void runSample(String sobjectType, String token,
              String instanceUrl, String content)
            throws AsyncApiException, ConnectionException, IOException {
        BulkConnection connection = getBulkConnection(token, instanceUrl);
    ...
    private BulkConnection getBulkConnection(String token,String instanceUrl)
        ...
        config.setRestEndpoint(instanceUrl + SF_URL);
