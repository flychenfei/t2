...
public class FacebookService {
    ...
    public List getFeedList(String accessToken, String userId, Integer limit, Integer offset) {
        Connection<JsonObject> myFeed = new DefaultFacebookClient(accessToken).fetchConnection(userId + "/feed", JsonObject.class, Parameter.with("limit", 25), Parameter.with("offset",0));
