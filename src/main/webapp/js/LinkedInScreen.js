            ...
            events: {
                ...
                "click;.glyphicon-user": function (e) {
                    ...
                    app.linkedInApi.userInfo(param).done(function (result) {
                        brite.display("LinkedInUserInfo", ".MainScreen", {
                            title: "Show UserInfo",
                    ...
                    switch (name) {
                        case "searchJobs":
                            brite.display("InputValue", ".MainScreen", {
                                title: 'Search Job', callback: function (keywork) {
                        ...
                        case "searchCompany":
                            brite.display("InputValue", ".MainScreen", {
                                title: 'Search Company', callback: function (keywork) {
                        ...
                        case "searchPeople":
                            brite.display("InputValue", ".MainScreen", {
                                title: 'Search People', callback: function (keywork) {
